...
|  uint8\_t | [**commandReceive**](#function-commandreceive) (HardwareSerial \* serialUSB) <br>_Function that reads the USB serial input._  |
...
_Function that reads the USB serial input._ 
```cpp
