...
[**File List**](files.md) **>** [**libraries**](dir_bc0718b08fb2015b8e59c47b2805f60c.md) **>** [**Radiocrafts\_RC17xxHP\_RC232**](dir_c5ffbea36932c83eb1d4acc4d97a1afa.md) **>** [**Radiocrafts\_RC17xxHP\_RC232.cpp**](Radiocrafts__RC17xxHP__RC232_8cpp.md)

[Go to the documentation of this file](Radiocrafts__RC17xxHP__RC232_8cpp.md)
...
uint8_t RC17xxHP_RC232::configExit() // Attempts to exit CONFIG mode
{
    ...
    if (_serial->available() == 0) // Alternative additional check to not discard received bytes: || (_serial->read() != '>')
    {
        return 0; // Success
    }
    flush();
