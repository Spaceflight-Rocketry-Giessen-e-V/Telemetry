...
# Class empty\_Component



[**ClassList**](annotated.md) **>** [**empty\_Component**](classempty__Component.md)
...
|   | [**empty\_Component**](#function-empty_component) (uint8\_t size) <br> |
...
```C++
virtual uint8_t empty_Component::decode (
    uint8_t * packet
) override
```
...
```C++
virtual void empty_Component::encode (
    uint8_t * packet
) override
```
