...
void radioModulesSetup(RC17xxHP_RC232 rc1780hp, RC17xxHP_RC232 rc1701hp,
                       ledStruct pinLed, uint8_t pinBuzzer);
void packetReceive(RC17xxHP_RC232 *radioModule, dataStruct dataVariables,
...
void launchControlCheck(uint8_t pinRX, uint8_t pinTX) uint8_t
    commandSend(RC17xxHP_RC232 radioModule, uint8_t command);
class ledStruct {
  public:
    uint8_t R;
    uint8_t G;
