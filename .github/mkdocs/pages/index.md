...
The API reference is generated by [MkDoxy](https://github.com/JakubAndrysek/MkDoxy) from C/C++ header and source files documented with [Doxygen](https://www.doxygen.nl/)-style comments. The website is built with [MkDocs](https://www.mkdocs.org/) and the [Material for MkDocs](https://squidfunk.github.io/mkdocs-material/) theme.
