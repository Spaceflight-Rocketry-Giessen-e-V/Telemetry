...
[In the repository](<../common/linkbudget simulation/linkbudget.py>), a Python script for a simple link budget simulation based on our expected flight profile is included.
It generates the following graphical output: <br>
<img src="../common/linkbudget simulation/linkbudget.png" width="800"/>
