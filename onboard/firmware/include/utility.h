...
void commandExecute(uint8_t command, RC17xxHP_RC232 *radioModule, dataStruct dataVariables, uint8_t *lowPowerMode, uint8_t *flightMode, Subsystem *subsystemSens, Subsystem *subsystemPower, Subsystem *subsystemControl, uint8_t *pinArm, uint8_t *pinSleep); //  Distribute Data To Subsystems etc..
