...
All hardware designs, firmware, and related materials in this repository are released under the [CERN Open Hardware Licence Version 2 - Strongly Reciprocal (OHL-S v2)](LICENSE.md). By contributing, you agree that your contributions will be released under this license.
...
Please open an [issue](https://github.com/Spaceflight-Rocketry-Giessen-e-V/Telemetry/issues) and tag the targeted component (software, hardware, firmware) using the issue labels.
